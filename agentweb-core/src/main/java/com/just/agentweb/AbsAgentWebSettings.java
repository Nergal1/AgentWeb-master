 ...
 * @author zhangchen
 *
 * @date 2019-04-25 10:05
 *
 * @Description WebView 配置和监听管理
 *
 */
...
public abstract class AbsAgentWebSettings implements IAgentWebSettings, WebListenerManager {
	...
	public static final String USERAGENT_AB = AgentWebConfig.AGENTWEB_VERSION;
