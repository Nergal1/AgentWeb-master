...
public class Action implements Parcelable {
	...
	public transient static final int ACTION_PERMISSION = 1;//权限动作，仅存内存，不参与序列化
	public transient static final int ACTION_FILE = 2;//文件动作，仅存内存，不参与序列化
	public transient static final int ACTION_CAMERA = 3;//相机动作，仅存内存，不参与序列化
	private ArrayList<String> mPermissions = new ArrayList();
	private int mAction;//记录当前动作
	private int mFromIntention;//记录意图来源
