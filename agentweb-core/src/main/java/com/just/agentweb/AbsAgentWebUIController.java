...
public static boolean HAS_DESIGN_LIB = false;
	...
	/*检测Snackbar和BottomSheetDialog库是否存在*/
	static {
		try {
			Class.forName("android.support.design.widget.Snackbar");//底部吐司条
			Class.forName("android.support.design.widget.BottomSheetDialog");//底部弹框
			HAS_DESIGN_LIB = true;
